...
public class RichEditor extends WebView {
  ...
  public RichEditor(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    loadUrl(SETUP_HTML);
//    loadData(SETUP_HTML,"text/html",null);
  ...
  public void insertImageWithId(String url, int id){
    exec("javascript:RE.prepareInsert();");
    exec("javascript:RE.insertImageWithId('" + url + "', '" + id + "');");
  }
...
//      loadUrl(trigger);
      loadData(trigger,"text/html",null);
    }
  }
