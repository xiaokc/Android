...
import com.google.xkc.sunshine.data.WeatherContract;
import com.google.xkc.sunshine.data.WeatherDbHelper;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        // query if you like)
        validateCurrentRecord("Error: More than one record returned from location query",
    ...
    private long insertNorthPoleLocationValues(Context context) {
    ...
    public void testWeatherTable() {
        ...
        long locationRowId = insertNorthPoleLocationValues(this.getContext());
